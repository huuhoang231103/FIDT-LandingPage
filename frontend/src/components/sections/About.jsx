            ...
            <div className="space-y-4">
              ...
              <div className="bg-gradient-to-r from-yellow-50 to-orange-50 border-l-4 border-yellow-400 p-4 rounded-r-lg">
                ...
                <div className="space-y-2 text-gray-700">
                  <p>🥇 <span className="font-medium">"Ngôi sao Toàn năng 2024"</span> – Team leader đạt KPI cao nhất tại <span className="font-bold">FIDT</span></p>
                  <p>🥇 <span className="font-medium">"Financial Planner xuất sắc 2023"</span> tại <span className="font-bold">FIDT</span></p>
