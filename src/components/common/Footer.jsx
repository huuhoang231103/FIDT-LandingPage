        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-white hover:text-blue-400 transition-colors">Mobile Apps</a></li>
              <li><a href="#" className="text-white hover:text-blue-400 transition-colors">Digital Marketing</a></li>
        ...
        <div className="border-t border-gray-100 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 text-sm">
              ...
              <a href="#" className="text-white hover:text-blue-400 transition-colors">Cookie Policy</a>
            </div>
          </div>
        </div>
      </div>
