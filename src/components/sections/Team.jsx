    ...
    return (
        <section id="team" className="scroll-mt-24 py-16 md:py-24">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {/* CEO Card */}
                <div className="ceo-card p-8 rounded-lg shadow-md mb-10 max-w-7xl mx-auto transition-all hover:shadow-lg hover:-translate-y-1 bg-gradient-to-br from-blue-50 to-blue-100 border-l-4 border-blue-600">
